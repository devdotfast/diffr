...
| name              | file                  |
| ----------------- | --------------------- |
| `default-dark`    | `onedark.toml`        |
| `default-light`   | `onelight.toml`       |
| `gruvbox`         | `gruvbox.toml`        |
| `solarized_light` | `solarized_light.toml` |

Any other Helix theme works through `theme.path` in diffr's config.
